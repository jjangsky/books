...
//
//public class EmpAndMemberRoleDTO {
////	EMP_NO		NUMBER					사원번호
...
//	private List<MemberRoleAndRoleDTO> memberRoleList = new ArrayList<>();		// 회원별권한리스트
//	public EmpAndMemberRoleDTO() {
//	}
//	public EmpAndMemberRoleDTO(int empNo, String empName, String empPhone1, String empPhone2, String empPhone3,
//			Date empBirth, String empGender, String empEmail, String empJobCode, String empAddress, String empDAddress,
//			Date empEntDate, Date empEndDate, String empEndYn, String empPwd, int deptCode,
//			List<MemberRoleAndRoleDTO> memberRoleList) {
//		this.empNo = empNo;
...
//		this.deptCode = deptCode;
//	}
//	public List<MemberRoleAndRoleDTO> getMemberRoleList() {
//		return memberRoleList;
//	}
//	public void setMemberRoleList(List<MemberRoleAndRoleDTO> memberRoleList) {
//		this.memberRoleList = memberRoleList;
//	}
//	@Override
//	public String toString() {
//		return "EmpAndMemberRoleDTO [empNo=" + empNo + ", empName=" + empName + ", empPhone1=" + empPhone1
//				+ ", empPhone2=" + empPhone2 + ", empPhone3=" + empPhone3 + ", empBirth=" + empBirth + ", empGender="
//				+ empGender + ", empEmail=" + empEmail + ", empJobCode=" + empJobCode + ", empAddress=" + empAddress
