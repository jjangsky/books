...
//		allocationSize = 1
//)
//public class EmpAndMemberRole implements Serializable{
...
//   
//   @OneToMany(mappedBy ="MemberRoleAndRole")
//   private List<MemberRoleAndRole> memberRoleList;
//
//public EmpAndMemberRole() {
//}
//
//public EmpAndMemberRole(int empNo, String empName, String empPhone1, String empPhone2, String empPhone3, Date empBirth,
//		String empGender, String empJobCode, String empEmail, String empAddress, String empDAddress, Date empEntDate,
//		Date empEndDate, String empEndYn, String empPwd, int deptCode, List<MemberRoleAndRole> memberRoleList) {
//	this.empNo = empNo;
...
//}
//
//public List<MemberRoleAndRole> getMemberRoleList() {
//	return memberRoleList;
//}
//
//public void setMemberRoleList(List<MemberRoleAndRole> memberRoleList) {
//	this.memberRoleList = memberRoleList;
//}
//
...
//	return "EmpAndMemberRole [empNo=" + empNo + ", empName=" + empName + ", empPhone1=" + empPhone1 + ", empPhone2="
//			+ empPhone2 + ", empPhone3=" + empPhone3 + ", empBirth=" + empBirth + ", empGender=" + empGender
//			+ ", empJobCode=" + empJobCode + ", empEmail=" + empEmail + ", empAddress=" + empAddress + ", empDAddress="
//			+ empDAddress + ", empEntDate=" + empEntDate + ", empEndDate=" + empEndDate + ", empEndYn=" + empEndYn
//			+ ", empPwd=" + empPwd + ", deptCode=" + deptCode + ", memberRoleList=" + memberRoleList + "]";
//}
//   
//   
//}
