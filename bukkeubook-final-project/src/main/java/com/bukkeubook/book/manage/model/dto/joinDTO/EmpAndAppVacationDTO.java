...
public class EmpAndAppVacationDTO implements Serializable {

	private static final long serialVersionUID = 5368233676736907045L;
...
//	EMPDTO									사원
	...
	public EmpAndAppVacationDTO() {
	}
	
	public EmpAndAppVacationDTO(int vacNo, Date vacAppNo, Date vacStartDate, Date vacEndDate, String vacReason,
			String vacStatus, int empNo, String vacEmer, String vacCompanion, EmpDTO emp) {
		this.vacNo = vacNo;
	...
	public String toString() {
		return "EmpAndAppVacationDTO [vacNo=" + vacNo + ", vacAppNo=" + vacAppNo + ", vacStartDate=" + vacStartDate
				+ ", vacEndDate=" + vacEndDate + ", vacReason=" + vacReason + ", vacStatus=" + vacStatus + ", empNo="
				+ empNo + ", vacEmer=" + vacEmer + ", vacCompanion=" + vacCompanion + ", emp=" + emp + "]";
	}
