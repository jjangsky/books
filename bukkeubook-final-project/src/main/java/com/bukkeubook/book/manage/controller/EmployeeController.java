...
public class EmployeeController {
	...
	/* 사원조회 , 페이징, 검색기능 */
	@GetMapping("/empList")
	public ModelAndView searchPage(HttpServletRequest request, ModelAndView mv) { // ModelAndView 뷰 리졸버의 역할 _리턴할 페이지 설정
																					// , 보내는객체
	...
	public ModelAndView empUpdatePage(ModelAndView mv, @PathVariable String empNo) {
		...
		System.out.println("^______________________________________________________^" + emp);
		...
		/* 현재 서명 조회 */
		SignDTO empSign = signService.findEmpSign2(number);
	...
	public ModelAndView modifyEmp(ModelAndView mv, RedirectAttributes rttr, EmpDTO emp, String deptCode1,
			String deptCode2, String empJobCode1, String empJobCode2) {
...
//	      mv.setViewName("redirect:/");
	...
	public ModelAndView modifySign(SignDTO signDTO, ModelAndView mv, HttpServletRequest request,
		...
		try {
			...
			SignDTO sign2 = new SignDTO();
			sign2.setEmpNo(empNo);
			sign2.setSignName(originFileName);
			sign2.setSignSavedName(saveName);

			signService.modifySign(sign2);
