...
//	VAC_COMPANION	NVARCHAR2(2000 CHAR)	휴가반려사유
	...
	public AppVacationAndEmpDTO() {
	}
	
	public AppVacationAndEmpDTO(int vacNo, Date vacAppNo, Date vacStartDate, Date vacEndDate, String vacReason,
			String vacStatus, int empNo, String vacEmer, String vacCompanion, EmpAndDeptDTO empAndDept) {
		this.vacNo = vacNo;
	...
	public String toString() {
		return "AppVacationAndEmpDTO [vacNo=" + vacNo + ", vacAppNo=" + vacAppNo + ", vacStartDate=" + vacStartDate
				+ ", vacEndDate=" + vacEndDate + ", vacReason=" + vacReason + ", vacStatus=" + vacStatus + ", empNo="
				+ empNo + ", vacEmer=" + vacEmer + ", vacCompanion=" + vacCompanion + ", empAndDept=" + empAndDept
				+ "]";
	}
